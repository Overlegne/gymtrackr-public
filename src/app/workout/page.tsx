...
function WorkoutContent() {
  ...
  if (!routine || !settings) return null;
...
export default function WorkoutPage() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center"><p className="text-muted-foreground animate-pulse">Initializing workout...</p></div>}>
      <WorkoutContent />
    </Suspense>
  );
}
