    ...
    <div className="flex flex-col min-h-screen bg-background">
      <header className="sticky top-0 z-20 bg-background/80 backdrop-blur-md border-b border-border/50 px-5 py-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-[10px] font-black uppercase tracking-widest">Personalize your journey</p>
        </div>
      </header>
      ...
      <main className="flex-1 p-5 space-y-6 pb-32">
        <Card className="border-none shadow-sm bg-card rounded-[2rem] overflow-hidden">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-[10px] font-black uppercase tracking-widest">Theme & Dark Mode</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-4">
            <div className="flex items-center justify-between bg-muted/20 p-4 rounded-2xl border border-border/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-black uppercase text-foreground">Theme Mode</p>
                  <p className="text-[10px] text-muted-foreground uppercase font-black">{theme}</p>
                </div>
              </div>
              <div className="flex bg-card rounded-xl p-1 shadow-sm border border-border/40">
                <Button 
        ...
        <Card className="border-none shadow-sm bg-card rounded-[2rem] overflow-hidden">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription className="text-[10px] font-black uppercase tracking-widest">Primary Color Engine</CardDescription>
              </div>
              <Button variant="ghost" size="sm" onClick={handleReset} className="h-8 text-[9px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary">
          ...
          <CardContent className="space-y-6 pt-4">
            ...
            <div className="bg-primary/5 p-5 rounded-[2rem] border border-primary/20">
              <h4 className="text-[10px] font-black uppercase tracking-widest text-primary/60 mb-3">Live Preview</h4>
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-2">
                  <div className="h-8 px-4 rounded-full bg-primary text-primary-foreground text-[10px] font-black flex items-center justify-center uppercase tracking-widest">Badge</div>
                  <div className="h-8 px-4 rounded-full border border-primary text-primary text-[10px] font-black flex items-center justify-center uppercase tracking-widest">Outline</div>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="text-center space-y-2 opacity-50 pb-10">
          <p className="text-[10px] font-black uppercase tracking-[0.3em]">My Strength Path v2.0</p>
