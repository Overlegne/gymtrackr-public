...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <header className="sticky top-0 z-20 bg-background/80 backdrop-blur-md border-b border-border px-5 pt-[calc(1.5rem+var(--safe-top))] pb-6 flex items-center gap-4">
        <Link href="/">
