...
const DEFAULT_EXERCISES: Exercise[] = [
  ...
  { id: '8', name: 'Leg Press', muscleGroup: 'Benen', equipment: 'Machine', defaultSets: 3, defaultReps: 15, imageUrl: 'https://picsum.photos/seed/legpress1/600/400' },
...
export const getRoutines = (): Routine[] => {
  ...
  if (!stored) {
    const exercises = getExercises();
    const initial = [
      { id: 'r1', name: 'Full Body A', exercises: [exercises[0], exercises[3], exercises[4]] },
      { id: 'r2', name: 'Push Day', exercises: [exercises[0], exercises[1], exercises[10], exercises[13]] },
    ];
